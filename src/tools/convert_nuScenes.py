...
def main():
  ...
  for split in SPLITS:
    ...
    out_path = OUT_PATH + '{}-part.json'.format(split)
    ...
    for sample in nusc.sample:
      ...
      if not (split in ['test']) and \
        ...
        continue
      if split in ['val'] and scene_name in SCENE_SPLITS[split]:
        eval_part.append(scene_name)
      ...
      for sensor_name in sample['data']:
        ...
        '''
        # split large dataset
        if split == 'train' and num_images // 10000 > num_packs:
            if num_images//10000 <=16:
                ret['images']=[]
                continue
            num_packs = num_images//10000
            images = ret['images']
            print(num_images, "reordering images for pack", num_packs)
            ...
            out_path = OUT_PATH + 'train{}.json'.format(num_packs)
...
'train':
    ['scene-0001', 'scene-0002', 'scene-0004', 'scene-0005', 'scene-0006', 'scene-0007', 'scene-0008', 'scene-0009',
     ...
     'scene-0259', 'scene-0260', 'scene-0261', 'scene-0262', 'scene-0263', 'scene-0264'],
'val':    
    ['scene-0003', 'scene-0012', 'scene-0013', 'scene-0014', 'scene-0015', 'scene-0016', 'scene-0017', 'scene-0018',
     'scene-0035', 'scene-0036', 'scene-0038', 'scene-0039', 'scene-0092', 'scene-0093', 'scene-0094', 'scene-0095',
     'scene-0096', 'scene-0097', 'scene-0098', 'scene-0099', 'scene-0100', 'scene-0101', 'scene-0102', 'scene-0103',
     'scene-0104', 'scene-0105', 'scene-0106', 'scene-0107', 'scene-0108', 'scene-0109', 'scene-0110', 'scene-0221',
     'scene-0268', 'scene-0269', 'scene-0270', 'scene-0271', 'scene-0272'],
    'mini_val':   
